...
//---------------------------------------------------------------------------
// CobraSboxDll_GetTagValue
//---------------------------------------------------------------------------


const WCHAR* CobraSboxDll_GetTagValue(const WCHAR* str, const WCHAR* strEnd, const WCHAR** value, ULONG* len, WCHAR sep)
{
    *value = NULL;
    *len = 0;
...
//---------------------------------------------------------------------------
// CobraSboxDll_EnumTagValues
//---------------------------------------------------------------------------


VOID CobraSboxDll_EnumTagValues(const WCHAR* string, CobraSboxDll_TagEnumProc enumProc, void* param, WCHAR eq, WCHAR sep)
{
    ...
    while(*str_ptr)
    {
        ...
        str_ptr = CobraSboxDll_GetTagValue(tmp + 1, NULL, &found_value, &found_len, sep);
...
BOOLEAN CobraSboxDll_FindTagValuePtr(const WCHAR* string, const WCHAR* tag_name, const WCHAR** value, ULONG* value_len, WCHAR eq, WCHAR sep)
{
    if (!string)
        return FALSE;
    ...
    CobraSboxDll_EnumTagValues(string, &Config_TagFindProc, &tagFindProcParam, eq, sep);
...
BOOLEAN CobraSboxDll_FindTagValue(const WCHAR* string, const WCHAR* tag_name, WCHAR* value, ULONG value_size, WCHAR eq, WCHAR sep)
{
    WCHAR* value_ptr;
    ULONG value_len;
    if (!CobraSboxDll_FindTagValuePtr(string, tag_name, &value_ptr, &value_len, eq, sep))
        return FALSE;
